...
@Component({
  selector: 'app-enquete-ne-vacants-logements',
  imports: [DataframeComponent],
  templateUrl: './enquete-ne-vacants-logements.component.html',
  styleUrl: './enquete-ne-vacants-logements.component.css'
})
export class EnqueteNeVacantsLogementsComponent {
  ...
  ngOnInit() {
    this.zone.run(() => {
        fetch(`https://10.209.10.213:8000/enquete-vacants-logements`, {
          method: 'GET',
          mode: 'cors'
        })
